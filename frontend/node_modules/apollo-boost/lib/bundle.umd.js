(function (global, factory) {
    ...
    var DefaultClient = (function (_super) {
        ...
        function DefaultClient(config) {
            ...
            process.env.NODE_ENV === "production" ? tsInvariant.invariant(!cache || !cacheRedirects, 1) : tsInvariant.invariant(!cache || !cacheRedirects, 'Incompatible cache configuration. When not providing `cache`, ' +
    ...
    Object.keys(apolloCacheInmemory).forEach(function (key) {
        Object.defineProperty(exports, key, {
            enumerable: true,
            get: function () {
                return apolloCacheInmemory[key];
            }
        });
    });
    Object.defineProperty(exports, 'HttpLink', {
        enumerable: true,
        get: function () {
            return apolloLinkHttp.HttpLink;
        }
    });
